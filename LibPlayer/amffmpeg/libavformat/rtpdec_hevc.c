                                              ...
                                              char *attr, char *value)
{
    ...
    if (!strcmp(attr, "profile-id")) {
        ...
        av_log(NULL, AV_LOG_INFO, "SDP: found profile-id: %d\n", hevc_data->profile_id);
    }
        ...
        while (*value) {
            ...
            *dst++ = '\0';
            ...
            if (decoded_packet_size > 0) {
                ...
                if (!tmp) {
                    av_log(NULL, AV_LOG_ERROR, "Unable to allocate memory for extradata!\n");
                                       ...
                                       PayloadContext *hevc_data, const char *line)
{
    ...
    if (av_strstart(sdp_line_ptr, "framesize:", &sdp_line_ptr)) {
        ...
        *str_video_width_ptr = '\0';
        ...
        int ret = ff_parse_fmtp(current_stream, hevc_data, sdp_line_ptr,
                              ...
                              int flags)
{
    ...
    */
    ...
    case 48:
        ...
        }
        {
            ...
            while ( pasered_len < len - 2 ) {
                ...
                memcpy(pkt->data + data_off, start_sequence, sizeof(start_sequence));
                data_off += sizeof(start_sequence);
                /* A/V packet: copy NAL unit data */
                memcpy(pkt->data + data_off, buf, nal_size);
                data_off += nal_size;
                pasered_len += nal_size;
                buf += nal_size;
                nalu_num ++ ;
            }
            pkt->size = data_off;
    ...
    pkt->flags |= AV_PKT_FLAG_WITH_HEADER;
